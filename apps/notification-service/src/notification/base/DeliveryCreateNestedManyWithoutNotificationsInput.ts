...
@InputType()
class DeliveryCreateNestedManyWithoutNotificationsInput {
...
export { DeliveryCreateNestedManyWithoutNotificationsInput as DeliveryCreateNestedManyWithoutNotificationsInput };
